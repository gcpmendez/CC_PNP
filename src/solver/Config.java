 ...
 *
 * No puede ser solo un HashMap<Literal, Boolean> porque necesitamos poder
 * incrementar de una configuracion a la siguiente.
 * 
 * No puede ser solo un ArrayList<Literal> o ArrayList<Boolean> porque
 * necesitamos poder pasarle un literal y que devuelva un booleano.
 */
public class Config implements Iterator<Config> {
	...
	public boolean hasNext() {
		...
		// Todos los valores a true == 11111... == no hay mas posibilidades
		// (elementos)!
		return false;
	}
	...
	public String toString() {
		...
		for (int i = 0; i < literalNames.size(); i++) {
			...
			rawValue = rawValues.get(i) ? "1" : "0"; // Comentar si se quiere
														// true/false en vez de
														// 1/0.
	...
	/*
	 * GETTERS Y SETTERS. Solo existen getters y setters conjuntos para evitar
	 * disparidad de datos.
	 */
